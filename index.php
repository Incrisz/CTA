...
<head>
	...
	<title>CTA Tax and Business Services - Quality Accounting Services </title>
				...
				<div class="container">
					<div class="header__top__inner">
						<ul class="header__top__info">
							<li>
								<a href="#"><i class="flaticon-old-typical-phone"></i> +27 12 004 0678</a>
							</li>
							<li>
								<a href="#"><i class="flaticon-black-back-closed-envelope-shape"></i> info@ctaaccountants.co.za</a>
							</li>
						</ul>
						<div class="header__top__button">
							<a class="cr-btn cr-btn--lg" href="#">
								<span>Open Hours: Mon - Fri 8.00 - 16.30</span>
							</a>
						</div>
					</div>
				</div>
						...
						<div class="row">
							<div class="col-lg-5">
								<div class="about-area__image">
									<img class="wow slideInLeft" data-wow-delay="0" src="assets/images/about/about-thumbnail.webp" alt="about area thumb">
								</div>
							</div>
							<div class="col-lg-7">
								<div class="about-area__content">
									...
									<p>Our Values are based on serving our customers in the best possible manner and these are:<br>
									...
									<div class="col-lg-6 col-md-6 wow flipInX">
										<div class="service">
											...
											<div class="service__content">
												...
												<p>Having an accountant frees up your time so you can focus on your business.Services include : </p>
											</div>
										</div>
									</div>
									<!--// Single Service -->
									...
									<div class="col-lg-6 col-md-6 wow flipInX">
										<div class="service">
											...
											<div class="service__content">
												...
												<p>Allows taxpayers to calculate their tax liability, schedule tax payments, or request refunds for overpayments. </p>
											</div>
										</div>
									</div>
									<!--// Single Service -->
				...
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-lg-8 col-md-10">
							<div class="section-title text-center">
								<!-- <h4>OUR TEAM</h4> -->
								<h2>MEET OUR
									<span class="color--theme">PARTHERS</span>
								</h2>
					...
					<div class="row advisors">
						...
						<div class="col-lg-2 col-sm-4">
							<figure class="advisor">
								<div class="advisor__image">
									<img src="assets/images/others/ACCA.png" alt="team member">
								</div>
						...
						<div class="col-lg-2 col-sm-4">
							<figure class="advisor">
								<div class="advisor__image">
									<img src="assets/images/others/OXFORD.png" alt="team member">
								</div>
								<figcaption class="advisor__content">
									<h6>
						...
						<div class="col-lg-2 col-sm-4">
							<figure class="advisor">
								<div class="advisor__image">
									<img src="assets/images/others/SAIBA.png" alt="team member">
								</div>
								<figcaption class="advisor__content">
									<h6>
						...
						<div class="col-lg-2 col-sm-4">
							<figure class="advisor">
								<div class="advisor__image">
									<img src="assets/images/others/RMSA.png" alt="team member">
								</div>
								<figcaption class="advisor__content">
									<h6>
						...
						<!--// Single Advisor -->
							...
							<div class="col-lg-2 col-sm-4">
								<figure class="advisor">
									<div class="advisor__image">
										<img src="assets/images/others/RMSA-1.png" alt="team member">
									</div>
									<figcaption class="advisor__content">
										<h6>
											<a href="#">Martin Smith</a>
					...
					<div class="row justify-content-center">
						<div class="col-lg-10">
							<div class="calltoaction text-center">
								...
								<p>CTA Tax and Business services is an accounting firm that provides various services in the broad accounting and financing field. cta provides a multitude of services to a wide variety of clients from its presence in Pretoria. </p>
								<h6>JUST DAIL
									<a href="callto://+27 12 004 0678">+27 12 004 0678</a> (TOLL FREE)</h6>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="container">
					...
					<div class="widget-area footer--widgets">
						...
						<section class="widget widget-about">
							<h5 class="widget-title">ABOUT CTA</h5>
							<p>CTA Tax and Business services is an accounting firm that provides various services in the broad accounting and financing field. cta provides a multitude of services to a wide variety of clients from its presence in Pretoria.</p>
						...
						<section class="widget widget-contact-info">
							...
							<ul>
								<li>
									<p>First Floor JJR Inc Building,
...
Pretoria, South Africa</p>
								...
								<li>
									<p>
										<a href="callto://+00812568987789">+27 12 004 0678</a>
									</p>
									<p>
										<a href="callto://+00835687567458">+27 12 004 0678</a>
									</p>
								</li>
								<li>
									<p>
										<a href="mailto:// info@ctaaccountants.co.za"> info@ctaaccountants.co.za</a>
									</p>
									<p>
										<a href="mailto:// info@ctaaccountants.co.za"></a>
									</p>
								</li>
							</ul>
						</section>
			...
			<div class="footer-area__copyright bg--dark">
				<div class="container">
					<div class="copyright text-center">
						<p>&copy;Copyright 2024 <span> CTA  </span>  Accounting. All rights reserved. <a href="#"></a></p>
					</div>
				</div>
			</div>
			<!--// Footer Copyright Area -->
